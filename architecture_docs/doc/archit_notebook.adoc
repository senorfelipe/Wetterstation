...
. REST-API
.. stellt Schnittstelle dar zur Datenabfrage, hauptsächllich vom Frontend genutzt
.. zusätzlich Schnittstelle zum Posten der Daten vom Raspi und der anschließenden Weiterverarbeitung
