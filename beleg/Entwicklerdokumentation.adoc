...
=== Frontend
In Wetterstation\beleg\Frontend\documentation liegt die index.html für die Anzeige der Systemdokumentation des Frontends. Doppelklcik auf die index.html ausführen und Dokumentation betrachten. +
