...
In diesem Usecase wird die Anzeige und das Bearbeiten der aufgenommenen Bilder behandelt.
...
==== Admins
Admins können scih diese Bilder ebenfalls anzeigen lassen, haben aber erweiterte Rechte, um Bilder zu bearbeiten, zu kopieren, zu verschieben oder zu löschen.

=== Vorbedingungen
//Vorbedingungen müssen erfüllt, damit der Use Case beginnen kann, z.B. Benutzer ist angemeldet, Warenkorb ist nicht leer...
. Die Kamera ist Funktionsfähig
. Die Kamera schaltet sich ein, wenn der Raspberry Pi sich einschaltet
. Die Kamera nimmt Bilder auf
. Die Bilder werden in der Datenbank richtig gespeichert
