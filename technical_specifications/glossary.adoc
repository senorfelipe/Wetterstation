...
|Raspi|Raspberry-Pi (gesamte Baureihe, es wurde kein Modell spezifiziert)| Einplatinen-Computer mit Linux-Distribution zur Datensammlung und Übermittlung an den Webserver
